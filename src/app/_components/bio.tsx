...
export default function Bio() {
  return (
    <div className="text-[1.25rem] grid grid-cols-1 gap-4 md:text-[1.5rem] lg:w-[500px]">
      <p>
      ...
      <p>
        ...
        computing, and developing Hiraya, a Filipino-based programming language.
      </p>

      <p>
        Now working as a Freelance Software Developer on side projects,
        previously a Full-Stack Developer at Faithful Threads.
      </p>
