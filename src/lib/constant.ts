import type { Highlight } from "@/app/works/page";
...
export const projectItems: ProjectItem[] = [
  ...
  },
  {
    title: "Binspire",
    description:
      "A Smart Waste Management System (SWMS) designed for Arcovia City, that focus on improving the efficiency and transparency of waste collection.",
    link: "https://www.binspire.space/",
    category: ["IoT", "HiveMQ", "Nginx", "Hono", "AWS", "MCP", "Azure AI"],
    highlights: [
      {
        text: "Arcovia City",
